                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="difficulty" class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500">
                            <option value="easy" {{ old('difficulty', $contest->difficulty) === 'easy' ? 'selected' : '' }}>{{ __('Easy') }}</option>
                            <option value="medium" {{ old('difficulty', $contest->difficulty) === 'medium' ? 'selected' : '' }}>{{ __('Medium') }}</option>
                            <option value="hard" {{ old('difficulty', $contest->difficulty) === 'hard' ? 'selected' : '' }}>{{ __('Hard') }}</option>
                        </select>
                    </div>
                    <div>
