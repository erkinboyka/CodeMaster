...
<head>
    ...
    <title>500 - {{ __('Server Error') }} - CodeMaster</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-output--magenta { color: #ec4899; }
        .error-cursor {
    ...
    <div class="error-page">
        ...
        <div class="error-terminal">
            ...
            <div class="error-terminal-body">
                ...
                <div class="error-line">
                    <span class="error-output error-output--red">HTTP/1.1 500 Internal Server Error</span>
                </div>
                <div class="error-line">
                    <span class="error-output error-output--yellow">Content-Type: text/html</span>
                </div>
                <div class="error-line">
                    <span class="error-output error-output--magenta">X-Error: something_broke</span>
                </div>
                <div class="error-line">
                    <span class="error-output">{{ __('ml_terminal_error_500') }}</span>
                </div>
                <div class="error-line">
                    <span class="error-prompt">$</span>
                    <span class="error-cmd">tail -f /var/log/error.log</span>
                </div>
                <div class="error-line">
                    <span class="error-output error-output--red">{{ __('ml_terminal_segfault') }}</span>
                </div>
                <div class="error-line">
                    <span class="error-prompt">$</span>
                    <span class="error-cmd">sudo reboot</span><span class="error-cursor"></span>
                </div>
            </div>
        </div>

        <div class="error-code">500</div>
        <div class="error-msg">{{ __('Server Error') }}</div>
        <div class="error-desc">{{ __('Something went wrong on our end. Our team has been notified and is working on a fix.') }}</div>
        ...
        <div class="error-actions">
            ...
            <button onclick="window.location.reload()" class="error-btn error-btn-secondary">
                <i class="fas fa-rotate-right"></i> {{ __('Try Again') }}
            </button>
        </div>
    </div>
</body>
