...
<head>
    ...
    <title>403 - {{ __('Unauthorized') }} - CodeMaster</title>
    ...
    <div class="error-page">
        ...
        <div class="error-terminal">
            ...
            <div class="error-terminal-body">
                ...
                <div class="error-line">
                    <span class="error-output error-output--red">HTTP/1.1 403 Forbidden</span>
                </div>
                <div class="error-line">
                    <span class="error-output error-output--yellow">Content-Type: text/html</span>
                </div>
                <div class="error-line">
                    <span class="error-output error-output--magenta">X-Permission-Denied: admin_required</span>
                </div>
                <div class="error-line">
                    <span class="error-output">{{ __('ml_terminal_403') }}</span>
                </div>
                <div class="error-line">
                    <span class="error-prompt">$</span>
                ...
                <div class="error-line">
                    <span class="error-output error-output--red">126</span>
                </div>
                <div class="error-line">
                    <span class="error-prompt">$</span>
        ...
        <div class="error-msg">{{ __('Access Denied') }}</div>
        <div class="error-desc">{{ __('You do not have permission to access this page. Admin access is required.') }}</div>
